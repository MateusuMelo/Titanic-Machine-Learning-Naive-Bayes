...
#Removendo valores faltantes. Atribuindo 200 pois são valores que dificilmente apareceriam nas colunas.
...
testes_final[['PassengerId','Survived']].to_csv('Previsão.csv',index=False)
